...
(function ($) {
    $.fn.pagepiling = function (options) {
        ...
        */
        ...
        $('.pp-section').each(function (index) {
           ...
           if(index > 0 && index <6){ //修改
            ...
            //vertical centered of the navigation + first bullet active($('#pp-nav').height()/2)
            if(options.navigation){
                $('#pp-nav').css('margin-top', '-' + '45px'); //修改
        ...
        */
        ...
        function addTableClass6(element){
            element.addClass('pp-table').wrapInner('<div class="pp-tableCell6" style="height:100%" />');
        }
        /**
        ...
        */
        function scrollPage(destination, animated) {
            ...
            /*start 自己添加的样式*/
              ...
              url = url.split("#");
              var number = url[1].substring(4,5);
              
              function changeLiOne(number){
                $('.li-img1').attr("class","li-img2");
                $('.li-img2').attr("class",'li-img2');
                $('.li-img2:eq('+number+')').attr("class",'li-img2 li-img2-hover');
                $('.li-img2').prev('a').css({'color':'#ccc'});
                $('.li-img2:eq('+number+')').prev('a').css({'color':'#fff'});
                $('.li-img2:eq(0)').attr("class",'li-img2 li-first');
              }
              function changeLiDouble(number) {
                    $('.li-img2').attr("class","li-img1");
                    $('.li-img1').attr("class",'li-img1');
                    $('.li-img1:eq('+number+')').attr("class",'li-img1 li-img1-hover');
                    $('.li-img1').prev('a').css({'color':'#ccc'});
                    $('.li-img1:eq('+number+')').prev('a').css({'color':'#00bde5'});
                    $('.li-img1:eq(0)').attr("class",'li-img1 li-first');
              }
              switch(number) {
                case '1' : 
                    changeLiOne(0); 
                    $('.li-img2:eq(0)').attr("class",'li-img2 li-hover1');
                    break;
                case '2' : 
                    changeLiDouble(1);
                    break;
            ...
            if (activeSection.index('.pp-section') < sectionIndex) {
                var translate3d = 'translate3d(0px, -140%, 0px)';
                var scrolling = '-140%';
